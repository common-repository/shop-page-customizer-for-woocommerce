...
if ( ! class_exists( 'woo_shop_customizer_style_library_Styles' ) ) :
/**
 ...
 */
class woo_shop_customizer_style_library_Styles {

	/**
	 * The one instance of woo_shop_customizer_style_library_Styles.
	 *
	 * @since 1.0.0.
	 *
	...
	/**
	 * Instantiate or return the one woo_shop_customizer_style_library_Styles instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return woo_shop_customizer_style_library_Styles
	 */
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `woo_shop_customizer_style_library_Styles()->add`. Because every property value has
...
if ( ! function_exists( 'woo_shop_customizer_style_library_styles' ) ) :
/**
 * Return the one woo_shop_customizer_style_library_Styles object.
 *
 * @since  1.0.0.
 *
 * @return woo_shop_customizer_style_library_Styles	The woo_shop_customizer_style_library_Styles object.
 */
function woo_shop_customizer_style_library_styles() {
	return woo_shop_customizer_style_library_Styles::instance();
}
endif;

add_action( 'init', 'woo_shop_customizer_style_library_styles', 1 );
?>